Shader "stillalive-studios/Triplanar/Triplanar Bumped Specular Parallax" {
	Properties {
		...
		_MainColor_SideX ("Side Color (RGB)", color) = (1,1,1,1)
		_MainColor_SideZ ("Front Color (RGB)", color) = (1,1,1,1)
...
#pragma exclude_renderers gles
	  ...
	  fixed4 _MainColor_SideX;
	  fixed4 _MainColor_SideZ;
      ...
      void surf (Input IN, inout SurfaceOutput o) 
      {
		...
		float2 uvRight = float2( IN.worldPos.z,-IN.worldPos.y )* _ScaleUV_Side;
 		...
 		colorMatrix[0] *= _MainColor_SideX.rgb;
		...
		// FRONT
 		...
 		SampleTexWithSpec( true,
 					...
 					/* IN */ uvFront, _ScaleParallax_Side, IN.viewDir_tangSpace, 
 					         _TexDiff_Side, _TexBump_Side, _TexSpec_Side );
 	 	colorMatrix[2] *= _MainColor_SideZ.rgb;
